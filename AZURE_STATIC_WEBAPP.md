...
This document describes the deployment of a web application frontend to Azure Static Web Apps.

## Configuration

The frontend is deployed to Azure Static Web Apps with the following configuration:

- **Region**: Central US (or your preferred region)
- **SKU**: Free (or Standard for production workloads)
- **Build Output Location**: dist
- **API Location**: https://your-function-app.azurewebsites.net

## Environment Variables

The following environment variables are required for the Azure Static Web App:

- `VITE_API_BASE`: The base URL for the API (https://your-function-app.azurewebsites.net)
